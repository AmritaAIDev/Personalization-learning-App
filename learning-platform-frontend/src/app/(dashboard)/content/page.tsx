    ...
    return (
      <div className="mx-auto flex min-h-screen max-w-2xl items-center p-6 sm:p-10">
        <section className="w-full rounded-[2rem] border border-[#ececf0] bg-white p-8 text-center shadow-[0_18px_45px_rgba(20, 20, 30,0.07)] sm:p-12">
          ...
          <h1 className="mt-6 font-heading text-3xl font-bold tracking-tight text-[#1a1a1f]">
            Reviewer access required
          </h1>
          <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-[#52525b]">
    ...
    <div className="mx-auto max-w-7xl p-5 sm:p-8 lg:p-10">
      <header className="flex flex-col gap-4 border-b border-[#ececf0] pb-7 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h1 className="mt-2 font-heading text-3xl font-bold tracking-tight text-[#1a1a1f] sm:text-4xl">
        ...
        <span className="inline-flex items-center gap-2 self-start rounded-full bg-[#e8f5ed] px-3 py-2 text-xs font-bold text-emerald-800 lg:self-auto">
      ...
      <section className="mt-7 grid gap-6 xl:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)]">
        <form
          ...
          className="rounded-[1.75rem] border border-[#ececf0] bg-white p-5 shadow-[0_14px_34px_rgba(20, 20, 30,0.05)] sm:p-6"
        >
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-xl bg-[#e7efe9] text-[#3f6f57]">
              <FilePenLine className="h-5 w-5" aria-hidden="true" />
            </span>
            <div>
              <h2 className="font-heading text-xl font-bold text-[#1a1a1f]">
          ...
          <div className="mt-6 grid gap-4">
            <label className="block">
              <span className="mb-2 block text-sm font-bold text-[#1a1a1f]">
                Subject
              </span>
              <input
                required
                ...
                className="w-full rounded-xl border border-[#dedee3] px-3 py-2.5 text-sm text-[#1a1a1f] focus:border-[#3f6f57] focus:ring-4 focus:ring-[#3f6f57]/10"
              />
            </label>
            <label className="block">
              <span className="mb-2 block text-sm font-bold text-[#1a1a1f]">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="block">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-[#dedee3] bg-white px-3 py-2.5 text-sm text-[#1a1a1f] focus:border-[#3f6f57] focus:ring-4 focus:ring-[#3f6f57]/10"
                >
          ...
          <button
            type="submit"
            disabled={generating}
            className="mt-6 inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-[#3f6f57] px-4 py-2.5 text-sm font-bold text-white shadow-[0_10px_22px_rgba(20, 20, 30,0.22)] transition hover:bg-[#315844] disabled:cursor-not-allowed disabled:opacity-60"
          >
            {generating ? (
              <LoaderCircle
        ...
        <section className="rounded-[1.75rem] border border-[#ececf0] bg-white p-5 shadow-[0_14px_34px_rgba(20, 20, 30,0.05)] sm:p-6">
          <div className="flex flex-col gap-4 border-b border-[#ececf0] pb-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <label className="inline-flex items-center gap-2 text-sm font-bold text-[#52525b]">
              ...
              <select
                ...
                className="rounded-xl border border-[#dedee3] bg-white px-3 py-2 text-sm font-bold text-[#1a1a1f] focus:border-[#3f6f57] focus:ring-4 focus:ring-[#3f6f57]/10"
              >
          ...
          {loading ? (
            ...
            <p className="mt-5 rounded-xl bg-[#f4f4f6] px-4 py-8 text-center text-sm leading-6 text-[#52525b]">
            ...
            <div className="mt-5 space-y-3">
              {records.map((record) => (
                <article
                  key={record.id}
                  className="rounded-2xl border border-[#ececf0] bg-[#fffdfd] p-4"
                >
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                      <div className="flex flex-wrap gap-2 text-xs font-bold">
                        <span className="rounded-full bg-[#e7efe9] px-2.5 py-1 text-[#2c4c3d]">
                          {record.status}
                        </span>
                        <span className="rounded-full bg-[#f4f4f6] px-2.5 py-1 text-[#52525b]">
                      ...
                      <h3 className="mt-1 text-sm font-bold leading-6 text-[#1a1a1f]">
                    ...
                    <div className="flex shrink-0 gap-2">
                      {record.status !== "PUBLISHED" && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-xl bg-[#3f6f57] px-3 py-2 text-xs font-bold text-white hover:bg-[#315844] disabled:opacity-60"
                        >
                      ...
                      {record.status !== "ARCHIVED" && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-xl border border-[#dedee3] px-3 py-2 text-xs font-bold text-[#52525b] hover:bg-[#f4f4f6] disabled:opacity-60"
                        >
                  ...
                  <details className="mt-4 rounded-xl bg-white">
                    <summary className="flex cursor-pointer list-none items-center gap-2 px-3 py-2.5 text-sm font-bold text-[#52525b]">
                      <FilePenLine
                        className="h-4 w-4 text-[#3f6f57]"
                        aria-hidden="true"
                      />{" "}
                      Review answer and explanation
                    </summary>
                    <div className="border-t border-[#ececf0] p-3">
