      ...
      <div className="mx-auto grid w-full max-w-5xl overflow-hidden rounded-[1.75rem] bg-surface hairline elevate lg:grid-cols-[1.02fr_0.98fr] animate-rise">
        ...
        <section className="relative hidden flex-col justify-between bg-ink p-12 text-white lg:flex">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[15px] font-semibold tracking-tight">JEE AI</span>
          </div>
          ...
          <div className="space-y-4 text-sm text-white/70">
            <p className="border-t border-white/10 pt-4">Private account sessions</p>
            <p className="border-t border-white/10 pt-4">Server-verified results</p>
          </div>
        </section>
        ...
        <section className="flex items-center justify-center p-8 sm:p-12">
          <div className="w-full max-w-sm">
            <div className="mb-9 flex items-center gap-3 lg:hidden">
              ...
              <span className="text-[15px] font-semibold tracking-tight text-ink">JEE AI</span>
            </div>
            <h2 className="font-heading text-[2rem] font-semibold tracking-tight text-ink">
              {title}
            </h2>
            <p className="mt-2 text-[15px] leading-6 text-ink-soft">{subtitle}</p>
