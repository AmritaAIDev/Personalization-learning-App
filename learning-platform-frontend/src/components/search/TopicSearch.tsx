  ...
  return (
    <section className="mx-auto w-full">
      ...
      >
        ...
        <kbd className="ml-auto hidden rounded-md border border-hairline bg-canvas px-1.5 py-0.5 text-[10px] font-semibold text-ink-mute sm:inline-flex">Ctrl K</kbd>
      </button>
